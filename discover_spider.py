...
class DiscoverSpider:
    def __init__(self, site_url, db, site_id, browser, existing_article_urls, max_try_times, timeout, should_use_original_url=False):
    ...
    def work(self):
        ...
        pipeline = DiscoverPipeline(site_id=self.site_id, db=self.db)
