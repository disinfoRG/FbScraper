...
class DiscoverSpider:
    def __init__(self, site_url, site_id, browser, existing_article_urls, logfile, max_try_times, timeout, should_use_original_url=False):
    ...
    def work(self):
        ...
        crawler = DiscoverCrawler(self.site_url, self.browser, self.existing_article_urls, parser, pipeline, self.logfile, self.timeout, self.max_try_times, self.should_use_original_url)
        crawler.crawl()
